...
class O_gpu_info {
  constructor(s_pci, s_name_brand_model_gpu, a_o_gpu_property_value) {
    this.s_pci = s_pci;
...
class O_gpu_property {
  constructor(s_name, s_description) {
    this.s_name = s_name;
...
class O_graph {
  constructor(
    ...
    this.s_name_brand_model_gpu = s_name_brand_model_gpu;
    this.a_o_gpu_property_value_visualization =
      a_o_gpu_property_value_visualization;
...
class O_window {
  constructor(
    ...
    (this.n_scl_x_nor = n_scl_x_nor), (this.n_scl_y_nor = n_scl_y_nor);
    this.o_gpu_property = o_gpu_property;
